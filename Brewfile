...
brew 'agg'          # AI-powered CLI for searching and summarizing docs
brew 'ffmpeg'       # Audio and video processing tools

# Multi Terminal (tutti cask disponibili)
cask "iterm2"
cask "wezterm"
cask "kitty"
cask "ghostty"
...
cask 'zap'      # Web app security scanner
cask 'wireshark-app'      # Network analyzer + packet capture
...
#brew bundle cleanup #remove software no longer in your Brewfile